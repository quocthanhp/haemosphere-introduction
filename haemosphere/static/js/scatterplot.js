(function(exports)
{
	...
	*/
	...
	{		
		...
		// Getting svgString is also possible by this.svg.node().parentNode.outerHTML, but this causes an XML parsing error
		// in Firefox. XMLSerializer method seems to work both ways.

		var serializer = new XMLSerializer();
		var svgString = serializer.serializeToString(this.svg.node())
